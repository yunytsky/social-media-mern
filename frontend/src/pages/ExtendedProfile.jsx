      ...
      <div className="flex-1 flex">
         ...
         <div className="flex flex-col px-16 py-6">
            <div >
               ...
               <span className="block font-bold text-gray-900 text-xl mb-2">{user.firstName + " " + user.lastName}</span>

            </div>

            
            <div className=" ">
               <div className="text-gray-600 mb-4 font-medium">Email: <span className="font-normal">{user.email}</span></div>
               <div className="text-gray-600 mb-4 font-medium">Birthday: <span className="font-normal">{user.birthDate}</span></div>
               {user.country && <div className="text-gray-600 mb-4 font-medium">Country: <span className="font-normal">{user.country}</span></div>}
               {user.town && <div className="text-gray-600 mb-4 font-medium">Town: <span className="font-normal">{user.town}</span></div>}
